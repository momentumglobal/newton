  ...
  return `
    <div class="rb-config">
      ...
      <div class="rb-section-label"
           style="font-size:11px;color:var(--c-gray-500);margin-top:2px">
  ...
  return `
    <style>
      #mr-obs-editor:empty:before {
        ...
        color: var(--c-gray-400); font-style: italic; pointer-events: none;
      }
    </style>
  ...
  const rows = visible.length
    ? visible.map(r => {
        ...
        <div class="rb-saved-row">
          ...
          <button class="btn-secondary btn-sm" style="color:var(--c-danger-alt);border-color:var(--c-danger-alt)"
